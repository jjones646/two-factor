...
/**
 * User Methods Table API: Two_Factor_User_Methods_Table class
 *
 * @package Two_Factor
...
/**
 * Core class used to implement displaying enabled two-factor methods in a table.
 *
 * @since 0.2-dev
 * @access private
 *
 * @see WP_List_Table
 */
class Two_Factor_User_Methods_Table extends WP_List_Table {
     ...
     * @access protected
     *
     * @return string Unalterable name for the primary column, in this case, 'method'.
     */
